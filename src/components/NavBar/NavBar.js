...
const NavBar = () => {
  ...
  return (
    <nav className="flex justify-evenly items-center bg-slate-200 py-6 text-slate-600">
      <NavLink to="/">
      ...
      <CartWidget className="flex justify-center items-center hover:bg-slate-400 hover:border-slate-400 hover:shadow-slate-400 rounded-md hover:shadow-lg transition-all duration-300 mx-1 py-2 w-20 min-w-fit" />
    </nav>
  );
};
